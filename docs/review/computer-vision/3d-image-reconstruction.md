...
Introduction Updated (23.03.12)
{: .label .label-green}

Review Coming Soon (23.03.15)
{: .label .label-yellow}
...
### Metrics
The paper[[1](#jin-et-al)] briefly explains 3 commonly used metric used: MSE, Voxel IoU and cross-entropy. I think the reader might familiar with MSE and cross-entropy. Therefore, I will skip their details.
